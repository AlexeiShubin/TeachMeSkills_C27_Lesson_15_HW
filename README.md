1) the program takes numbers from the console as input, fills the collection with them and displays only the even elements of the collection using the parityCheck method
